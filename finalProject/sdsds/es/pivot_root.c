...
int pivot_root(void)
{
   ...
   /* Ensure that our image directory exists. It doesn't really matter what's
      in it. */
   if (mkdir("/home/ubuntu/CSC595/Project/newroot", 0755) && errno != EEXIST)
      TRY (errno);

   if (rename("./rootfs.tar", "/home/ubuntu/CSC595/Project/newroot/rootfs.tar") && errno != EEXIST)
	TRY (errno);
   ...
   TRY (mount("/home/ubuntu/CSC595/Project/newroot", "/home/ubuntu/CSC595/Project/newroot", NULL,
   ...
   TRY (mount("/home/ubuntu/CSC595/Project", "/home/ubuntu/CSC595/Project", NULL, MS_REC | MS_BIND | MS_PRIVATE, NULL));
   ...
   TRY (chdir("/home/ubuntu/CSC595/Project/newroot"));

   ret = img_extract("rootfs.tar");
   printf("ret:%d",ret);
   TRY (chdir("/home/ubuntu/CSC595/Project/"));
   ...
   TRY (mount("/home/ubuntu/CSC595/Project", "/", NULL, MS_MOVE, NULL));
